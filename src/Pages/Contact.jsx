...
const Contact = () => {
    ...
    return (
        <div id='page1' className='pt-1 h-full  w-screen bg-white relative'>

            {/* Trim Path SVG */}
            <div className='absolute  md:-top-2 md:-left-[1vw] md:w-[59vw] w-[10vw] -top-30 right-[79vw] '>
            ...
            <div
                ref={rotatingTextRef}
                className="absolute flex md:top-30 top-30 md:right-[18vw] origin-center right-[34vw] items-center justify-center pointer-events-none"
            >
            ...
            {/* Image */}
            <div ref={imageDivRef} className='absolute overflow-hidden lg:h-[45vw] h-[95vw] lg:rounded-3xl rounded-xl lg:w-[25vw] w-[75vw] lg:top-30 top-21 md:left-[10vw] right-[3vw]' >
                <Image className="w-full h-full object-cover" />
            </div>

            <div className='relative font-[font2]'>
                <div className='lg:mt-[25vh] mt-[35vh] p-3 overflow-hidden'>
                    <div className='leading-[2vw] overflow-hidden'>
                        <div className='lg:mt-[5vh] mt-[30vh]'>
                            <h1 className='md:text-[10vw] text-[17vw] text text-start md:text-center uppercase md:leading-[7vw] leading-[10.5vw]'>Contact</h1>
                        </div>
                    </div>
                    <div className='leading-[10vw] overflow-hidden'>
                        <div className='leading-[2vw] overflow-hidden'>
                            <div className='lg:mt-[2vh] mt-[3vw]'>
                                <h1 className='md:text-[10vw] text-[12vw] text text-end md:text-start right-20 md:right-0 relative md:left-[33vw] uppercase md:leading-[7vw] leading-[9vw]'>Me</h1>
                            </div>
                        </div>
                    </div>

                    {/* Contact Form */}
                    <div className='md:pl-[40%] md:-mt-[1vw] mt-4 px-1 overflow-hidden contact-form'>
