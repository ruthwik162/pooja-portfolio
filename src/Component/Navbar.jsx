    ...
    return (
        <div className='bg-white flex w-full top-0 items-center z-11 justify-between fixed'>
            ...
            <div className='overflow-hidden'>
                <div className='logo leading-2 mx-[2vw] w-[25vw] md:w-[10vw]'>
                    <Link to="/">
            ...
            <div className='flex'>
                <div
                    ...
                    className='bg-black h-[12vw]  sm:h-[6vw] md:h-[7.2vw] lg:h-[4vw] xl:h-[5vw] relative cursor-pointer w-[38vw] sm:w-[30vw] md:w-[19vw] lg:w-[20vw] xl:w-[15vw] '>
                ...
                <div
                    ...
                    className='bg-black h-[12vw]  sm:h-[6vw] md:h-[7.2vw] lg:h-[6.7vw] xl:h-[7vw] relative cursor-pointer w-[38vw] sm:w-[30vw] md:w-[19vw] lg:w-[20vw] xl:w-[15vw] '>
