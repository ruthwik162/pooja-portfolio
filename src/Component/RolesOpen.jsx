...
const RolesOpen = () => {
    ...
    useEffect(() => {
        ...
        // ✅ Unlock audio on first click (fix autoplay restrictions)
        const unlockAudio = () => {
            if (audioRef.current) {
    ...
    return (
        <div className="bg-white min-h-screen w-full flex flex-col items-center justify-center pt-3 md:pt-10">
                ...
                {roles.map((role, i) => (
                    ...
                    >
                        <div className="relative py-3 flex items-center gap-3 md:gap-[20vh] mx-[10vw] md:mx-[20vw] z-10">
                            ...
                            <span className="role-text text-[3vw] md:text-[1vw] text-black">{role}</span>
                        </div>
            ...
            {/* ✅ Correct path: file must be inside /public */}
