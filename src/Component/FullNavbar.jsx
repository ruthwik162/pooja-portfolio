...
const FullScreenNav = () => {
  ...
  return (
    <div ref={fullScreenRef} id='fullscreennav' className='fullscreennav fixed h-full bg-black hidden text-white overflow-x-hidden md:top-0 -top-0 w-full z-99 '>

      <div ref={fullNavLinksRef} className='relative'>
        <div className="navlink flex w-full justify-between lg:p-5 p-2 items-start">
          <div className=''>
            <div className='lg:w-[10vw]  p-5 w-24'>
              <div className='absolute md:top-[2vw] md:left-[13.5vw] -top-[0.5vw] z-1 '>
                <img src={images.purpleflower} className='w-5 animate-spin [animation-duration:2s]' alt="" />
              </div>
              <div className="logo leading-2 mx-[2vw] border p-1 bg-white rounded-tl-md rounded-br-md w-[25vw] md:w-[10vw]">
                <Link to="/">
          ...
          <div onClick={() => {
            setNavOpen(false)
          }} className='lg:h-[5vw] h-20 w-20 lg:w-[5vw] relative cursor-pointer'>
            <div className='lg:h-[7vw] h-28 lg:w-1 w-0.5 -rotate-45 origin-top absolute bg-[#D3FD50]'></div>
            <div className='lg:h-[7vw] h-28 lg:w-1 w-0.5 right-0 rotate-45 origin-top absolute bg-[#D3FD50]'></div>
          </div>
        </div>
        <div className=' py-[2vw] mt-[20vw] md:mt-[8vw]'>

          <div onClick={() => handleNavClick("/")}
            onMouseEnter={(e) => handleHover(e.currentTarget, true)}
            onMouseLeave={(e) => handleHover(e.currentTarget, false)}
            className='link origin-top cursor-pointer relative border-y-1 border-white'>
            <h1 className='font-[font2] text-5xl lg:text-[6vw] text-center lg:leading-[0.8] lg:pt-10 pt-3 uppercase'>Home</h1>
          ...
          <div onClick={() => handleNavClick("/profile")}
            ...
            <h1 className='font-[font2] text-5xl lg:text-[6vw] text-center lg:leading-[0.8] lg:pt-10 pt-3 uppercase'>Profile</h1>
          ...
          <div onClick={() => handleNavClick("/projects")}
            ...
            onMouseLeave={(e) => handleHover(e.currentTarget, false)}
            className='link origin-top cursor-pointer relative border-t-1 border-white'>
            <h1 className='font-[font2] text-5xl lg:text-[6vw] text-center lg:leading-[0.8] lg:pt-10 pt-3 uppercase'>Projects</h1>
